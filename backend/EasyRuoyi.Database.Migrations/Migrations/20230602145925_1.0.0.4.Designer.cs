...
namespace EasyRuoyi.Database.Migrations.Migrations
{
    ...
    [Migration("20230602145925_1.0.0.4")]
    partial class _1004
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.Employee", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Id");
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Id");
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.RoleMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Id");
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.RoleUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Id");
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.SysFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Id");
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.UserInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Id");
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.RoleMenu", b =>
                {
                    b.HasOne("EasyRuoyi.Entities.Entities.Menu", "Menu")
                        .WithMany()
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("EasyRuoyi.Entities.Entities.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.RoleUser", b =>
                {
                    ...
                    b.HasOne("EasyRuoyi.Entities.Entities.UserInfo", "UserInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("EasyRuoyi.Entities.Entities.UserInfo", b =>
                {
                    b.HasOne("EasyRuoyi.Entities.Entities.Employee", "Employee")
                        .WithOne()
                        .HasForeignKey("EasyRuoyi.Entities.Entities.UserInfo", "EmployeeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
