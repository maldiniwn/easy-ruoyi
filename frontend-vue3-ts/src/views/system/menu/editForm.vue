<template>
  <el-dialog title="修改菜单" v-model="dialogVisible" :close-on-click-modal="false" append-to-body @close="close()">
    <el-form ref="formRef" :model="reactiveData.form" :rules="rules" label-width="100px">
      <el-row>
        <el-col :span="24">
          <el-form-item label="上级菜单" prop="pId">
            <el-input v-model="reactiveData.form.pName" disabled></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
